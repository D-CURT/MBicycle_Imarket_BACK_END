...
var IndexComponent = /** @class */ (function () {
    ...
    IndexComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('/index').subscribe(function (data) {
            _this.products = data;
        });
    };
...
module.exports = __webpack_require__(/*! C:\Projects\front\frontMarket\src\main.ts */"./src/main.ts");
