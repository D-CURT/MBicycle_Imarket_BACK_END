...
@Component
public class DataBaseFulfiller {
    @Autowired
    ...
    public void run(String...args) throws Exception {
        ...
        Category categoryComputerSystems = new Category("Computer Systems");
            Group groupLaptops = new Group("Laptops", categoryRepository.findByName("Computer Systems"));
        ...
        Product productPC1000 = new Product();
            ...
            productPC1000.setStoreStatus(false);
            productPC1000.setPrice(999);
            productPC1000.setDiscount(0);
        ...
        categoryRepository.save(categoryComputerComponents);
            groupLaptops.setCategory(categoryRepository.findByName(categoryComputerComponents.getName()));
            ...
            groupPCs.setCategory(categoryRepository.findByName(categoryComputerComponents.getName()));
        ...
        categoryRepository.save(categoryComputerSystems);
            groupGraphicsCard.setCategory(categoryRepository.findByName(categoryComputerSystems.getName()));
